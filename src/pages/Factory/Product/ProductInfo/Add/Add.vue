<template>
	<div>
		<Dialog className="addProduct" title="新建产品" @closeDialog="closeDialog">
			<div class="slotDiv">
				<el-form :model="addFormData" label-position="left" label-width="80px" ref="addForm">
					<div class="baseInfo">
						<el-form-item label="产品名称" class="fromItem isRequired" prop="name">
							<el-input @blur="validName(addFormData.name)" ref="name" maxlength="20" placeholder="请输入产品名称" v-model="addFormData.name"></el-input>
						...
						<el-form-item label="产品类别" class="fromItem isRequired" prop="category">
							<el-select @blur="validCategory(addFormData.category)" @change="validCategory(addFormData.category)" v-model="addFormData.category" placeholder="请选择产品类别" @focus="getCategoryData">
								<el-option
						...
						<div class="content">
							...
							<div class="right">
								<div class="materielUl">
									<div class="materielItem" v-for="(item, index) in addFormData.materielList">
										<el-autocomplete
											placeholder="请输入物料名称"
											class="meterialId"
...
<script type="text/javascript">
	...
	export default {
		props: [ 'changeDialogStatus', 'selectProductId' ],
		components: { Dialog },
		data() {
			let statusObj = {
				status: false,
